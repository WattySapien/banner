  ...
  if (receipt) {
    ...
    <div className="mx-auto max-w-xl py-3 sm:py-16">
      <div className="rounded-2xl border bg-card p-5 text-center sm:p-10">
        ...
        <div className="mt-7 flex flex-col gap-1 rounded-xl bg-muted/60 p-4 text-left text-sm min-[380px]:flex-row min-[380px]:items-center min-[380px]:justify-between"><span className="text-muted-foreground">Reference</span><span className="break-all font-mono text-xs font-medium sm:text-sm">{completed.reference}</span></div>
