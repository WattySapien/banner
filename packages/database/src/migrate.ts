...
const migrationFiles = ["0001_banking_schema.sql", "0002_account_numbers.sql", "0003_internal_transfers.sql", "0004_peer_transfers.sql", "0005_card_issuance_notifications.sql", "0006_user_avatars.sql", "0007_account_holder_names.sql", "0008_support_messages.sql", "0009_support_message_notifications.sql", "0010_mastercard_network.sql", "0011_security_audit_events.sql"];
